...
public class ArticleTagController {
    ...
    public Result<Map<String, Object>> feedback(
        ...
        Long boardId = body.get("boardId") instanceof Number n ? n.longValue()
                : Long.parseLong(String.valueOf(body.get("boardId")));
        String name = String.valueOf(body.get("proposedName") != null ? body.get("proposedName") : "");
