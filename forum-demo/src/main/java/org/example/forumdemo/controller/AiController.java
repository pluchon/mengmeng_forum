...
public class AiController {
    ...
    private static final String K_GEMINI_FLASH = "gemini_flash";
    ...
    public Result<AiPriceEstimateVO> priceEstimate(
        ...
        if ("drawing".equalsIgnoreCase(skill) || "image".equalsIgnoreCase(skill)) {
            ...
            model = premium ? "gpt-image-2" : "z-image-turbo";
            in = 0;
            out = 0;
            img = 1;
        } else {
    ...
    @Operation(summary = "对话写作", description = "kind: deepseek_flash | deepseek_pro | gemini_flash | gemini_pro")
    @PostMapping("/write")
    public Result<Map<String, Object>> write(@RequestBody AiWriteRequest req, HttpServletRequest request) {
        ...
        try {
            ...
            } else if (K_GEMINI_FLASH.equals(kind) || K_GEMINI_PRO.equals(kind)) {
    ...
    public Result<Map<String, Object>> image(@RequestBody AiImageRequest req, HttpServletRequest request) {
        ...
        String modelCode = "premium".equals(q) ? "gpt-image-2" : "z-image-turbo";
        ...
        try {
            ...
            if (url != null) {
                companionMemoryService.appendImageMessage(dbSessionId, "assistant", url, null);
            }
    ...
    private static String modelCodeForWriteKind(String kind) {
        ...
        return switch (kind) {
            ...
            case K_GEMINI_FLASH -> "gemini-3-flash";
            case K_GEMINI_PRO -> "gemini-3.1-pro";
            default -> null;
        };
    }
}
