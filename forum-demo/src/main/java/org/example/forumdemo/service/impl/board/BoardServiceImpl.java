...
public class BoardServiceImpl implements BoardService {
    ...
    public List<Board> queryBoardListByOrder(Integer orderBy) {
        ...
        LambdaQueryWrapper<Board> wrapper = new QueryWrapper<Board>().lambda().ne(Board::getState, 1);
        if (orderBy == 0) {
    ...
    public Board queryBoardByBoardId(Long boardId) {
        ...
        Board board = boardMapper.selectOne(new QueryWrapper<Board>().lambda()
    ...
    public void addOneById(Long boardId) {
        ...
        int result = boardMapper.update(null, new UpdateWrapper<Board>().lambda()
