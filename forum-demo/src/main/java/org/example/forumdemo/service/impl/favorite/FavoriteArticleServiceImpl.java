...
public class FavoriteArticleServiceImpl implements FavoriteArticleService {
    ...
    public Long saveFavorite(SaveFavoriteRequest req, Long loginUserId) {
        ...
        ArticleFavorite exist = favoriteMapper.selectOne(new QueryWrapper<ArticleFavorite>().lambda()
        ...
        try {
            if (exist == null) {
                ...
                int updated = favoriteMapper.update(null, new UpdateWrapper<ArticleFavorite>().lambda()
    ...
    public void cancelFavorite(Long articleId, Long loginUserId) {
        ...
        ArticleFavorite row = favoriteMapper.selectOne(new QueryWrapper<ArticleFavorite>().lambda()
                .eq(ArticleFavorite::getUserId, loginUserId)
                .eq(ArticleFavorite::getArticleId, articleId)
    ...
    public boolean isFavorited(Long articleId, Long loginUserId) {
        ...
        Long count = favoriteMapper.selectCount(new QueryWrapper<ArticleFavorite>().lambda()
                .eq(ArticleFavorite::getUserId, loginUserId)
                .eq(ArticleFavorite::getArticleId, articleId)
                .ne(ArticleFavorite::getDeleteState, DELETE_YES));
    ...
    public PageResult<FolderArticleVO> queryFolderArticles(Long folderId, Long loginUserId,
        ...
        Page<ArticleFavorite> result = favoriteMapper.selectPage(page, new QueryWrapper<ArticleFavorite>().lambda()
    ...
    private Map<Long, UserBriefVO> batchLoadAuthors(java.util.Collection<Article> articles) {
