...
import org.example.forumdemo.mapper.SystemMessageMapper;
...
public class SystemMessageServiceImpl implements SystemMessageService {
    ...
    public Page<SystemMessage> queryByUser(Long userId, Integer pageNum, Integer pageSize) {
        ...
        QueryWrapper<SystemMessage> w = new QueryWrapper<>();
        w.lambda().eq(SystemMessage::getReceiveUserId, userId)
    ...
    public int markAllRead(Long userId) {
        ...
        return systemMessageMapper.update(null, new UpdateWrapper<SystemMessage>().lambda()
    ...
    public void markOneRead(Long messageId, Long loginUserId) {
        ...
        systemMessageMapper.update(null, new UpdateWrapper<SystemMessage>().lambda()
    ...
    public long countUnread(Long userId) {
        ...
        Long cnt = systemMessageMapper.selectCount(new QueryWrapper<SystemMessage>().lambda()
                .eq(SystemMessage::getReceiveUserId, userId)
                .eq(SystemMessage::getState, STATE_UNREAD)
                .ne(SystemMessage::getDeleteState, DELETE_TRUE));
