...
@Slf4j
@Service
public class ArticleGuideStreamService {
    ...
    private void indexGuideSummaryToRag(Article published, String guideSummary) {
        ...
        try {
            ...
            ragPayload.put("articleId", published.getId());
            ...
            ragPayload.put("summary", guideSummary);
            if (author != null) {
                ragPayload.put("authorNickname", author.getNickname());
            }
