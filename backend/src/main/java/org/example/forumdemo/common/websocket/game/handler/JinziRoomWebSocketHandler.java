...
// 井字棋房间 WebSocket，负责落子、认输、聊天和重连
@Slf4j
@Component
public class JinziRoomWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        try {
            ...
            JinziRoomStateVO state = jinziRoomService.joinRoom(roomId, userId, session);
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        try {
            ...
            log.error("井字棋房间消息处理失败 roomId={}, userId={}, type={}, error={}",
    ...
    private void handleRoomMessage(WebSocketSession session,
        ...
        if ("move".equals(wsMessage.getType())) {
            ...
            jinziRoomService.handleMove(roomId, userId, request.getRow(), request.getCol(), wsMessage.getRequestId());
            return;
        }
        if ("chat".equals(wsMessage.getType())) {
            ...
            jinziRoomService.chat(roomId, userId, request, wsMessage.getRequestId());
            return;
        }
    ...
    private String resolveRoomId(WebSocketSession session) {
        ...
        String prefix = "/ws/games/jinzi/rooms/";
