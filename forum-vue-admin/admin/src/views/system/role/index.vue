<template>
  <GiPageLayout margin>
    ...
    <RoleGrantForumAdminModal ref="RoleGrantForumAdminModalRef" />
  </GiPageLayout>
</template>
...
import RoleGrantForumAdminModal from './RoleGrantForumAdminModal.vue'

defineOptions({ name: 'SystemRole' })

const { dictData } = useDict(['STATUS'])
const RoleFormModalRef = useTemplateRef('RoleFormModalRef')
const RoleGrantForumAdminModalRef = useTemplateRef('RoleGrantForumAdminModalRef')
...
const onGrantForumAdmin = () => {
  RoleGrantForumAdminModalRef.value?.open()
}
