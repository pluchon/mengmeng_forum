  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '^/(user|board|article|message|mail|sms|category|like|file|articleReply|articleSubReply|checkin|shop|points|favorite|search|system-message|mascot|lottery|game|vip|ai|notice|captcha)/': {
