  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '^/(user|board|article|articleDanmaku|message|mail|sms|category|like|file|articleReply|articleSubReply|replyLike|checkin|shop|points|favorite|search|system-message|mascot|lottery|game|vip|growth|ai|notice|captcha|drift-bottle|group-chat|exam-question-bank)/': {
