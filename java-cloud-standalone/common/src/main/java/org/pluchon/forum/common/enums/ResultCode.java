...
public enum ResultCode {
    ...
    FAILED_LOGIN(1103, "账号或凭证错误"),
    FAILED_LOGIN_LOCKED(1210, "登录失败次数过多，请15分钟后再试"),
    ...
    FAILED_CHECKIN_MAKEUP_CARD_NOT_ENOUGH(1202, "补签卡不足"),
    FAILED_CHECKIN_MAKEUP_DATE_INVALID(1203, "近30天没有可补签的漏签日"),
    FAILED_CHECKIN_MAKEUP_ALREADY_SIGNED(1204, "该日期已签到, 无需补签"),
    ...
    FAILED_AUDIT_EDIT_LOCKED(1205, "帖子正在审核中, 暂时无法编辑, 请等待审核结果"),
    ...
    FAILED_REPLY_MEDIA_TOO_MANY(1173, "评论附件数量超出限制"),
    FAILED_REPLY_MEDIA_INVALID(1174, "评论附件无效"),
    FAILED_REPLY_CONTENT_EMPTY(1175, "评论内容不能为空"),
    FAILED_DANMAKU_NOT_VIDEO(1176, "仅视频帖支持弹幕"),
    FAILED_DANMAKU_NOT_PUBLISHED(1177, "帖子未发布，无法发送或查看弹幕"),
    FAILED_DANMAKU_CONTENT_EMPTY(1178, "弹幕内容不能为空"),
    FAILED_DANMAKU_CONTENT_TOO_LONG(1179, "弹幕内容过长"),
    FAILED_DANMAKU_COLOR_INVALID(1180, "弹幕颜色无效"),
    FAILED_DANMAKU_RATE_LIMIT(1181, "发送弹幕过于频繁，请稍后再试"),
    FAILED_DANMAKU_TIME_INVALID(1182, "弹幕时间点无效"),
    FAILED_DANMAKU_WINDOW_TOO_LARGE(1183, "弹幕查询时间窗口过大"),
    FAILED_DANMAKU_MODE_INVALID(1184, "弹幕模式无效"),
    FAILED_DANMAKU_FONT_SIZE_INVALID(1185, "弹幕字号无效"),
    FAILED_DANMAKU_DUPLICATE(1186, "请勿重复发送相同弹幕"),
    FAILED_DANMAKU_MINUTE_LIMIT(1187, "发送弹幕过于频繁，请稍后再试"),
    FAILED_DANMAKU_NOT_FOUND(1188, "弹幕不存在"),
    FAILED_DANMAKU_HIDE_FORBIDDEN(1189, "无权隐藏该弹幕"),
    ...
    FAILED_VIP_SUBSCRIBE_UNAVAILABLE(1198, "积分订阅已下线，请通过扫码支付开通会员"),
    FAILED_SHOP_SERIES_OFFLINE(1199, "该表情包系列已下架"),
    FAILED_SHOP_EMOJI_DELETED(1200, "该表情已被删除"),
    FAILED_SHOP_EMOJI_NOT_OWNED(1201, "你尚未拥有该表情包"),
    FAILED_RATE_LIMITED(1206, "操作过于频繁，请稍后再试"),
    FAILED_SERVICE_UNAVAILABLE(1207, "服务暂时不可用，请稍后重试"),
    FAILED_SERVICE_TIMEOUT(1208, "服务响应较慢，请稍后重试"),
    FAILED_UPLOAD_TOO_LARGE(1209, "上传文件过大，请压缩后重试"),
