...
@Mapper
public interface UserMusicFavoriteMapper extends BaseMapper<UserMusicFavorite> {
     ...
     * 收藏的人还能靠它继续听。
     */
    @Update("UPDATE user_music_favorite SET title = #{title}, artist = #{artist}, album = #{album}, "
