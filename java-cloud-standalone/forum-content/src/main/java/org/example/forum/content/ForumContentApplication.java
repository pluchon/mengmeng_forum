package org.example.forum.content;
...
@EnableFeignClients(basePackages = "org.example.forum.api")
public class ForumContentApplication {

    public static void main(String[] args) {
        ForumDateTimes.useShanghaiAsDefault();
        SpringApplication.run(ForumContentApplication.class, args);
    }
}
